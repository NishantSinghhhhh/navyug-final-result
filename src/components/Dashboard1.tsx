...
const Dashboard: React.FC = () => {
 ...
 const generatePdfFiles = () => {
  results.forEach((school) => {
    ...
    const message = `We are delighted to announce that ${schoolName} secured the ${school.tag} rank in ${categoryText} at Navyug 2024-25. This remarkable achievement is a testament to the dedication and hard work of our students and faculty. We extend our heartfelt congratulations and best wishes for your continued success in all future endeavors!`;
    ...
    pdf.rect(tableX, tableY - 8, tableWidth, 10 + (school.students.length * 12));
    ...
    headers.forEach((header, index) => {
      ...
      if (index < headers.length - 1) {
        ...
        pdf.line(
          ...
          tableY - 8,
          xHeaderPos + columnWidths[index],
          tableY + 2 + (school.students.length * 12)
        );
      }
      xHeaderPos += columnWidths[index];
    });
    ...
    school.students.forEach((student, index) => {
      ...
      if (index % 2 === 0) {
        ...
        pdf.rect(tableX, yPos - 6, tableWidth, 12, "F");
      }
    ...
    yPos += 5     
    const message2 = "We kindly request that you provide the school's account details for the prize money transfer. Thank you for your cooperation."
    const wrappedText2 = pdf.splitTextToSize(message2, 180);
